        ...
        {(user?.role === "EMPLOYE" || user?.role === "MANAGER") && (
          <div className="relative z-10">
            <button 
              ...
              className="inline-flex items-center justify-center gap-2 bg-teal-600 text-white px-6 py-3 rounded-2xl font-bold uppercase text-[10px] tracking-widest shadow-lg shadow-teal-600/20 hover:bg-teal-700 active:scale-95 transition-all"
            >
              <Plus size={18} />
