    ...
    <div className="space-y-6 lg:space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-6 bg-gradient-to-br from-sky-50/80 via-white to-blue-50/30 border border-sky-100/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-6 lg:p-8 overflow-hidden mb-2">
        ...
        <div className="relative z-10 border-l-4 border-sky-500 pl-5">
          <h1 className="text-3xl lg:text-4xl font-heading font-black italic text-slate-800 tracking-tight drop-shadow-sm">Gestion des Demandes</h1>
          <p className="text-slate-500 font-medium text-sm mt-2">Consultez et gérez vos requêtes RH</p>
        </div>
        {(user?.role === "EMPLOYE" || user?.role === "MANAGER") && (
          <div className="relative z-10">
            <button 
              onClick={() => setIsModalOpen(true)} 
              className="inline-flex items-center justify-center gap-2 bg-sky-600 text-white px-6 py-3 rounded-2xl font-bold uppercase text-[10px] tracking-widest shadow-lg shadow-sky-600/20 hover:bg-sky-700 active:scale-95 transition-all"
            >
              <Plus size={18} />
        ...
        <div className="p-4 lg:p-6 border-b border-slate-100 bg-slate-50/30">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 lg:gap-3">
              <select 
                className="bg-white border border-slate-200 rounded-xl px-3 py-2 text-xs sm:text-sm font-medium text-slate-700 outline-none focus:ring-2 focus:ring-sky-500/20 transition-all cursor-pointer"
                value={filterType}
        ...
        {responseRequest && (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                className="w-full bg-white border border-slate-200 rounded-xl p-4 font-medium text-slate-700 focus:border-sky-500 outline-none min-h-[100px] resize-none transition-all"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group border-2 border-dashed border-slate-200 rounded-xl p-6 hover:border-sky-400 hover:bg-sky-50/30 transition-all cursor-pointer">
                <input 
                  type="file" 
                ...
                <div className="flex flex-col items-center gap-2">
                  <Paperclip className="text-slate-400 group-hover:text-sky-600 transition-colors" size={24} />
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button 
                ...
                className="flex-[2] flex items-center justify-center gap-2 bg-sky-600 text-white px-4 py-3 rounded-xl font-semibold text-sm shadow-sm hover:bg-sky-700 transition disabled:opacity-50"
              >
