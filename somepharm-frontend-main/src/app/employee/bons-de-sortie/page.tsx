    ...
    <div className="space-y-6 lg:space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-6 bg-gradient-to-br from-sky-50/80 via-white to-blue-50/30 border border-sky-100/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-6 lg:p-8 overflow-hidden mb-2">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 bg-white border border-slate-200 px-5 py-3 rounded-2xl text-sky-600 font-bold text-sm shadow-sm">
            <Shield size={18} /> 
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 lg:p-8">
            ...
            <form onSubmit={demanderSortie} className="space-y-5">
              <div className="space-y-4">
                <div className="bg-slate-50 p-4 rounded-xl space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <select 
                            className="w-full bg-white border border-slate-200 p-2.5 rounded-lg font-bold text-slate-700 outline-none focus:border-sky-500 shadow-sm cursor-pointer"
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50 border border-slate-200 p-4 rounded-xl text-sm font-semibold text-slate-700 min-h-[80px] focus:outline-none focus:border-sky-500 focus:bg-white transition-all resize-none"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-sky-600 text-white font-bold uppercase tracking-widest text-[10px] py-4 rounded-xl shadow-lg shadow-sky-600/20 hover:bg-sky-700 active:scale-95 transition-all disabled:opacity-50"
              >
        ...
        <div className="xl:col-span-8 space-y-4">
          <div className="flex items-center justify-between px-1">
            ...
            <div className="text-[10px] font-bold text-slate-400 flex items-center gap-1.5 italic">
              <Info size={14} className="text-sky-500" /> Codes QR actifs après validation
            </div>
          </div>
                ...
                return (
                  <div key={sortie.idRequete} className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col sm:flex-row items-center gap-6 justify-between transition-all hover:shadow-md group">
                    ...
                    <div className="shrink-0 flex flex-col items-center gap-3">
                        ...
                        <div className="relative group/qr p-3 bg-white border border-slate-100 rounded-2xl shadow-sm transition-all hover:bg-slate-50">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover/qr:opacity-100 transition-opacity bg-slate-900/10 rounded-2xl">
                            <button 
                              ...
                              className="p-2 bg-white text-sky-600 rounded-full shadow-lg hover:scale-110 transition-all"
                            >
                              <Download size={18} />
                            </button>
                          </div>
                      ...
                      {isApproved && <span className="text-[9px] font-bold text-sky-600 uppercase tracking-widest bg-sky-50 px-2.5 py-1 rounded-full border border-sky-100">Prêt</span>}
                    </div>
                  </div>
                );
              })}
