    ...
    <div className="space-y-6 lg:space-y-8 animate-in fade-in duration-700 pb-12">
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-6 bg-gradient-to-br from-teal-50/80 via-white to-emerald-50/30 border border-teal-100/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-6 lg:p-8 overflow-hidden mb-2">
        ...
        <div className="relative z-10 border-l-4 border-teal-500 pl-5">
          <div className="inline-flex items-center gap-2 bg-teal-50 text-teal-700 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider mb-2 border border-teal-100 shadow-sm">
             Identité Digitale
          </div>
        ...
        <div className="relative z-10">
          <button 
            ...
            className="inline-flex items-center justify-center gap-2 bg-white border border-slate-200 shadow-sm hover:border-teal-500 hover:text-teal-600 px-6 py-3 rounded-2xl font-bold text-sm transition-all group active:scale-95"
          >
