        ...
        <div className="min-h-screen space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 pb-20">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
                ...
                <div className="xl:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div 
                        onClick={() => window.location.href = "/admin/activation"}
                        className="bg-white rounded-[3rem] p-10 border border-gray-100 shadow-sm hover:shadow-xl transition-all cursor-pointer group flex flex-col items-center justify-between"
                    >
                ...
                <div className="xl:col-span-4 space-y-8">
                    ...
                    <div 
                        ...
                        className="bg-white rounded-[3rem] p-10 border border-gray-100 shadow-sm hover:shadow-xl transition-all cursor-pointer group"
                    >
                    ...
                    <div 
                        ...
                        className="bg-white rounded-[3rem] p-10 border border-gray-100 shadow-sm hover:shadow-xl transition-all cursor-pointer group space-y-10"
                    >
                        <div className="space-y-4">
