        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <select 
                ...
                className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none font-semibold text-sm focus:border-teal-500 focus:bg-white transition-all"
              >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-3 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none font-semibold text-sm focus:border-teal-500 focus:bg-white transition-all"
                    />
                  </div>
                </div>
                <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <textarea 
                  ...
                  className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none font-semibold text-sm focus:border-teal-500 focus:bg-white transition-all resize-none"
                />
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative group h-[78px]">
                  ...
                  />
                  <div className="h-full bg-slate-50 border-2 border-dashed border-slate-200 rounded-xl flex flex-col items-center justify-center p-2 group-hover:border-teal-500 transition-all">
                    <Upload size={16} className="text-slate-400 group-hover:text-teal-600 mb-1" />
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button 
              type="submit"
              disabled={loading}
              className="flex-[2] py-3 bg-teal-600 text-white rounded-xl text-xs font-bold uppercase tracking-widest shadow-md hover:bg-teal-700 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
