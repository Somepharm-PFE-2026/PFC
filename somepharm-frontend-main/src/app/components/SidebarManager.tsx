        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar space-y-8 pr-2">
          ...
          <div>
            {(!isSidebarRetracted || isMobileOpen) && (
              <p className="text-[10px] font-bold text-emerald-200/50 uppercase tracking-widest mb-4 ml-4 animate-in fade-in duration-500">Pilotage d'Équipe</p>
            )}
          ...
          <div>
             {(!isSidebarRetracted || isMobileOpen) && (
               <p className="text-[10px] font-bold text-emerald-200/50 uppercase tracking-widest mb-4 ml-4 animate-in fade-in duration-500">Espace Personnel</p>
             )}
            <nav className="space-y-2">
