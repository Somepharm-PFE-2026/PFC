        ...
        <div className="relative h-24 lg:h-28 flex flex-col items-center justify-center pt-2 mb-6 lg:mb-4 shrink-0">
          ...
          {!isSidebarRetracted && (
            <button 
              ...
              className="hidden lg:flex absolute -right-2 top-8 p-2 bg-teal-800 border border-teal-600 rounded-xl text-teal-200 hover:text-white hover:bg-teal-700 hover:shadow-lg transition-all z-20 group"
            >
