    ...
    return (
        <div className="space-y-6 lg:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 lg:gap-6">
                <div className={`w-12 h-12 lg:w-16 lg:h-16 ${isEmployee ? "bg-sky-600 shadow-sky-600/20" : "bg-teal-600 shadow-teal-600/20"} rounded-2xl lg:rounded-[2rem] flex items-center justify-center text-white shadow-lg shrink-0`}>
                    <Settings size={28} />
                </div>
                <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-4">
                    <div className="bg-white rounded-2xl border border-slate-100 p-6 lg:p-8 shadow-sm flex flex-col items-center text-center">
                        ...
                        <p className={`text-[10px] font-bold ${isEmployee ? "text-sky-600" : "text-teal-600"} uppercase tracking-widest mt-1`}>
                ...
                <div className="lg:col-span-8 space-y-6 lg:space-y-8">
                    <div className="bg-white rounded-2xl border border-slate-100 p-6 lg:p-10 shadow-sm relative overflow-hidden">
                        <div className={`absolute top-0 right-0 w-32 h-32 ${isEmployee ? "bg-sky-50" : "bg-teal-50"} rounded-full blur-3xl -mr-16 -mt-16 opacity-50`} />
                     ...
                     <div className={`${isEmployee ? "bg-sky-600 shadow-sky-600/20" : "bg-teal-600 shadow-teal-600/20"} rounded-2xl p-6 lg:p-10 text-white shadow-lg relative overflow-hidden group`}>
                        ...
                        <p className={`${isEmployee ? "text-sky-50" : "text-teal-50"} text-sm font-medium leading-relaxed mb-6 opacity-90 max-w-lg`}>
                        ...
                        <button className={`bg-white ${isEmployee ? "text-sky-600 hover:bg-sky-50" : "text-teal-600 hover:bg-teal-50"} px-6 py-3 rounded-xl font-bold uppercase text-[10px] tracking-widest shadow-lg transition-all active:scale-95`}>
